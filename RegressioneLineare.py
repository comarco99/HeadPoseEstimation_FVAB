...
#caricamento dei dati
    ...
    test1.to_csv("C:/Users/costa/Desktop/PROGETTO_FRATTALI_HDP/pitchtest.csv", index =False)
    predizioni1=pd.DataFrame(predizioni1)
    predizioni1.to_csv("C:/Users/costa/Desktop/PROGETTO_FRATTALI_HDP/pitchpredizioni.csv", index =False)

    test2= pd.DataFrame(test2)
    test2.to_csv("C:/Users/costa/Desktop/PROGETTO_FRATTALI_HDP/yawtest.csv", index =False)
    predizioni2 = pd.DataFrame(predizioni2)
    predizioni2.to_csv("C:/Users/costa/Desktop/PROGETTO_FRATTALI_HDP/yawpredizioni.csv", index =False)

    test3= pd.DataFrame(test3)
    test3.to_csv("C:/Users/costa/Desktop/PROGETTO_FRATTALI_HDP/rolltest.csv", index =False)
    predizioni3 = pd.DataFrame(predizioni3)
    predizioni3.to_csv("C:/Users/costa/Desktop/PROGETTO_FRATTALI_HDP/rollpredizioni.csv", index =False)
